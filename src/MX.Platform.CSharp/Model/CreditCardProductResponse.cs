...
namespace MX.Platform.CSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreditCardProductResponse")]
    public partial class CreditCardProductResponse : IEquatable<CreditCardProductResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreditCardProductResponse);
        }

        /// <summary>
        /// Returns true if CreditCardProductResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditCardProductResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditCardProductResponse input)
        {
            if (input == null)
            {
                return false;
