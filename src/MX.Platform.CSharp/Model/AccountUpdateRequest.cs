...
namespace MX.Platform.CSharp.Model
{
    ...
    public partial class AccountUpdateRequest : IEquatable<AccountUpdateRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="accountSubtype">Can only be updated for manual accounts..</param>
        /// <param name="accountType">Can only be updated for manual accounts..</param>
        /// <param name="apr">Can only be updated for manual accounts..</param>
        /// <param name="apy">Can only be updated for manual accounts..</param>
        /// <param name="availableBalance">Can only be updated for manual accounts..</param>
        /// <param name="balance">Can only be updated for manual accounts..</param>
        /// <param name="cashSurrenderValue">Can only be updated for manual accounts..</param>
        /// <param name="creditLimit">Can only be updated for manual accounts..</param>
        /// <param name="currencyCode">Can only be updated for manual accounts..</param>
        /// <param name="deathBenefit">Can only be updated for manual accounts..</param>
        /// <param name="interestRate">Can only be updated for manual accounts..</param>
        /// <param name="isBusiness">Can be updated for manual accounts and aggregated accounts..</param>
        /// <param name="isClosed">Can only be updated for manual accounts..</param>
        /// <param name="isHidden">Can be updated for manual accounts and aggregated accounts..</param>
        /// <param name="loanAmount">Can only be updated for manual accounts..</param>
        /// <param name="metadata">Can only be updated for manual accounts..</param>
        /// <param name="name">Can only be updated for manual accounts..</param>
        /// <param name="nickname">Can only be updated for manual accounts..</param>
        /// <param name="originalBalance">Can only be updated for manual accounts..</param>
        /// <param name="propertyType">Can only be updated for manual accounts..</param>
        /// <param name="skipWebhook">If set to true, prevents sending an account webhook for the update if that webhook type is enabled for you..</param>
        ...
        /// </summary>
        /// <value>Can only be updated for manual accounts.</value>
        ...
        /// </summary>
        /// <value>Can be updated for manual accounts and aggregated accounts.</value>
        ...
        /// </summary>
        /// <value>If set to true, prevents sending an account webhook for the update if that webhook type is enabled for you.</value>
