...
namespace MX.Platform.CSharp.Model
{
    ...
    public partial class ScheduledPaymentsResponseBody : IEquatable<ScheduledPaymentsResponseBody>, IValidatableObject
    {
        ...
        public ScheduledPaymentsResponseBody(List<ScheduledPaymentResponse> scheduledPayments = default(List<ScheduledPaymentResponse>), PaginationResponse pagination = default(PaginationResponse))
        {
