...
namespace MX.Platform.CSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstitutionsResponseBody")]
    public partial class InstitutionsResponseBody : IEquatable<InstitutionsResponseBody>, IValidatableObject
    {
        ...
        public InstitutionsResponseBody(List<InstitutionResponse> institutions = default(List<InstitutionResponse>), PaginationResponse pagination = default(PaginationResponse))
        {
