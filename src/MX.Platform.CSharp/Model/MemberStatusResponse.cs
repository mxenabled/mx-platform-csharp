...
namespace MX.Platform.CSharp.Model
{
    ...
    public partial class MemberStatusResponse : IEquatable<MemberStatusResponse>, IValidatableObject
    {
        ...
        public MemberStatusResponse(string aggregatedAt = default(string), List<ChallengeResponse> challenges = default(List<ChallengeResponse>), string connectionStatus = default(string), string guid = default(string), bool? hasProcessedAccountNumbers = default(bool?), bool? hasProcessedAccounts = default(bool?), bool? hasProcessedTransactions = default(bool?), bool? isAuthenticated = default(bool?), bool? isBeingAggregated = default(bool?), string successfullyAggregatedAt = default(string))
        {
