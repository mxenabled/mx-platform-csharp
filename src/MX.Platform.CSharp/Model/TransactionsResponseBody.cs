...
namespace MX.Platform.CSharp.Model
{
    ...
    public partial class TransactionsResponseBody : IEquatable<TransactionsResponseBody>, IValidatableObject
    {
        ...
        public TransactionsResponseBody(List<TransactionResponse> transactions = default(List<TransactionResponse>), PaginationResponse pagination = default(PaginationResponse))
        {
