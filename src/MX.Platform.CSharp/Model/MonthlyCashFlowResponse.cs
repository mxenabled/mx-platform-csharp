...
namespace MX.Platform.CSharp.Model
{
    ...
    public partial class MonthlyCashFlowResponse : IEquatable<MonthlyCashFlowResponse>, IValidatableObject
    {
        ...
        [DataMember(Name = "estimated_goals_contribution", EmitDefaultValue = true)]
        public decimal? EstimatedGoalsContribution { get; set; }
        ...
        public bool Equals(MonthlyCashFlowResponse input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.EstimatedGoalsContribution != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EstimatedGoalsContribution != null)
                {
