...
namespace MX.Platform.CSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberResumeRequestBody")]
    public partial class MemberResumeRequestBody : IEquatable<MemberResumeRequestBody>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MemberResumeRequestBody);
        }

        /// <summary>
        /// Returns true if MemberResumeRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of MemberResumeRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MemberResumeRequestBody input)
        {
            if (input == null)
            {
                return false;
