...
namespace MX.Platform.CSharp.Model
{
    ...
    /// RewardsResponse
    /// </summary>
    [DataContract(Name = "RewardsResponse")]
    public partial class RewardsResponse : IEquatable<RewardsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardsResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RewardsResponse);
        }

        /// <summary>
        /// Returns true if RewardsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RewardsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RewardsResponse input)
        {
            if (input == null)
            {
                return false;
