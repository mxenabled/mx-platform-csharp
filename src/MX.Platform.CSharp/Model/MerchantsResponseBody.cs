...
namespace MX.Platform.CSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MerchantsResponseBody")]
    public partial class MerchantsResponseBody : IEquatable<MerchantsResponseBody>, IValidatableObject
    {
        ...
        public MerchantsResponseBody(List<MerchantResponse> merchants = default(List<MerchantResponse>), PaginationResponse pagination = default(PaginationResponse))
        {
