...
namespace MX.Platform.CSharp.Model
{
    ...
    /// VCResponse
    /// </summary>
    [DataContract(Name = "VCResponse")]
    public partial class VCResponse : IEquatable<VCResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VCResponse" /> class.
        /// </summary>
        /// <param name="verifiableCredential">verifiableCredential.</param>
        public VCResponse(string verifiableCredential = default(string))
        {
            this.VerifiableCredential = verifiableCredential;
        }

        /// <summary>
        /// Gets or Sets VerifiableCredential
        /// </summary>
        ...
        [DataMember(Name = "verifiableCredential", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VerifiableCredential: ").Append(VerifiableCredential).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as VCResponse);
        }

        /// <summary>
        /// Returns true if VCResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of VCResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VCResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.VerifiableCredential == input.VerifiableCredential ||
                    (this.VerifiableCredential != null &&
                    this.VerifiableCredential.Equals(input.VerifiableCredential))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.VerifiableCredential.GetHashCode();
                }
                return hashCode;
            }
        }
