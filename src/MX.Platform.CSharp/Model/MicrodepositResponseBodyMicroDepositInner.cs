...
namespace MX.Platform.CSharp.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MicrodepositResponseBody_micro_deposit_inner")]
    public partial class MicrodepositResponseBodyMicroDepositInner : IEquatable<MicrodepositResponseBodyMicroDepositInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MicrodepositResponseBodyMicroDepositInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MicrodepositResponseBodyMicroDepositInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MicrodepositResponseBodyMicroDepositInner" /> class.
        /// </summary>
        ...
        public MicrodepositResponseBodyMicroDepositInner(string accountName = default(string), string accountNumber = default(string), string accountType = default(string), string email = default(string), string firstName = default(string), string lastName = default(string), string routingNumber = default(string), string errorMessage = default(string), string guid = default(string), string institutionCode = default(string), string institutionName = default(string), string status = default(string), string updatedAt = default(string), string verifiedAt = default(string))
        {
            ...
            {
                throw new ArgumentNullException("accountNumber is a required property for MicrodepositResponseBodyMicroDepositInner and cannot be null");
            }
            this.AccountNumber = accountNumber;
            // to ensure "accountType" is required (not null)
            if (accountType == null)
            {
                throw new ArgumentNullException("accountType is a required property for MicrodepositResponseBodyMicroDepositInner and cannot be null");
            }
            this.AccountType = accountType;
            // to ensure "routingNumber" is required (not null)
            if (routingNumber == null)
            {
                throw new ArgumentNullException("routingNumber is a required property for MicrodepositResponseBodyMicroDepositInner and cannot be null");
            }
        ...
        {
            return this.Equals(input as MicrodepositResponseBodyMicroDepositInner);
        }

        /// <summary>
        /// Returns true if MicrodepositResponseBodyMicroDepositInner instances are equal
        /// </summary>
        /// <param name="input">Instance of MicrodepositResponseBodyMicroDepositInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MicrodepositResponseBodyMicroDepositInner input)
        {
            if (input == null)
            {
                return false;
