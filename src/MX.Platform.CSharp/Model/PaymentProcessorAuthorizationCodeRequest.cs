...
namespace MX.Platform.CSharp.Model
{
    ...
    public partial class PaymentProcessorAuthorizationCodeRequest : IEquatable<PaymentProcessorAuthorizationCodeRequest>, IValidatableObject
    {
        ...
        protected PaymentProcessorAuthorizationCodeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentProcessorAuthorizationCodeRequest" /> class.
        /// </summary>
        /// <param name="accountGuid">accountGuid (required).</param>
        /// <param name="memberGuid">memberGuid (required).</param>
        ...
        public PaymentProcessorAuthorizationCodeRequest(string accountGuid = default(string), string memberGuid = default(string), string userGuid = default(string))
        {
            ...
            if (accountGuid == null)
            {
                throw new ArgumentNullException("accountGuid is a required property for PaymentProcessorAuthorizationCodeRequest and cannot be null");
            }
            this.AccountGuid = accountGuid;
            // to ensure "memberGuid" is required (not null)
            if (memberGuid == null)
            {
                throw new ArgumentNullException("memberGuid is a required property for PaymentProcessorAuthorizationCodeRequest and cannot be null");
            }
            this.MemberGuid = memberGuid;
            // to ensure "userGuid" is required (not null)
            if (userGuid == null)
            {
                throw new ArgumentNullException("userGuid is a required property for PaymentProcessorAuthorizationCodeRequest and cannot be null");
            }
