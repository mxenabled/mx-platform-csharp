...
namespace MX.Platform.CSharp.Api
{
    ...
    public interface ISpendingPlanApiSync : IApiAccessor
    {
        ...
        SpendingPlanIterationResponse ReadCurrentSpendingPlanIteration(string userGuid, string spendingPlanGuid, int? page = default(int?), int? recordsPerPage = default(int?), int operationIndex = 0);
        ...
        ApiResponse<SpendingPlanIterationResponse> ReadCurrentSpendingPlanIterationWithHttpInfo(string userGuid, string spendingPlanGuid, int? page = default(int?), int? recordsPerPage = default(int?), int operationIndex = 0);
        /// <summary>
    ...
    public interface ISpendingPlanApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SpendingPlanIterationResponse> ReadCurrentSpendingPlanIterationAsync(string userGuid, string spendingPlanGuid, int? page = default(int?), int? recordsPerPage = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SpendingPlanApi : ISpendingPlanApi
    {
        ...
        /// <summary>
        /// Read current spending plan iteration Use this endpoint to read the attributes of the current spending plan &#x60;iteration&#x60;.
        /// </summary>
        /// <exception cref="MX.Platform.CSharp.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userGuid">The unique identifier for a &#x60;user&#x60;, beginning with the prefix &#x60;USR-&#x60;.</param>
        /// <param name="spendingPlanGuid">The unique ID for the &#x60;spending_plan&#x60;.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SpendingPlanIterationResponse</returns>
        public SpendingPlanIterationResponse ReadCurrentSpendingPlanIteration(string userGuid, string spendingPlanGuid, int? page = default(int?), int? recordsPerPage = default(int?), int operationIndex = 0)
        {
            MX.Platform.CSharp.Client.ApiResponse<SpendingPlanIterationResponse> localVarResponse = ReadCurrentSpendingPlanIterationWithHttpInfo(userGuid, spendingPlanGuid, page, recordsPerPage);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SpendingPlanIterationResponse</returns>
        public MX.Platform.CSharp.Client.ApiResponse<SpendingPlanIterationResponse> ReadCurrentSpendingPlanIterationWithHttpInfo(string userGuid, string spendingPlanGuid, int? page = default(int?), int? recordsPerPage = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'userGuid' is set
            if (userGuid == null)
            {
                throw new MX.Platform.CSharp.Client.ApiException(400, "Missing required parameter 'userGuid' when calling SpendingPlanApi->ReadCurrentSpendingPlanIteration");
            }

            // verify the required parameter 'spendingPlanGuid' is set
            if (spendingPlanGuid == null)
            {
                throw new MX.Platform.CSharp.Client.ApiException(400, "Missing required parameter 'spendingPlanGuid' when calling SpendingPlanApi->ReadCurrentSpendingPlanIteration");
            }
            ...
            localVarRequestOptions.Operation = "SpendingPlanApi.ReadCurrentSpendingPlanIteration";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<SpendingPlanIterationResponse>("/users/{user_guid}/spending_plans/{spending_plan_guid}/iterations/current", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ReadCurrentSpendingPlanIteration", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SpendingPlanIterationResponse</returns>
        public async System.Threading.Tasks.Task<SpendingPlanIterationResponse> ReadCurrentSpendingPlanIterationAsync(string userGuid, string spendingPlanGuid, int? page = default(int?), int? recordsPerPage = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            MX.Platform.CSharp.Client.ApiResponse<SpendingPlanIterationResponse> localVarResponse = await ReadCurrentSpendingPlanIterationWithHttpInfoAsync(userGuid, spendingPlanGuid, page, recordsPerPage, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<MX.Platform.CSharp.Client.ApiResponse<SpendingPlanIterationResponse>> ReadCurrentSpendingPlanIterationWithHttpInfoAsync(string userGuid, string spendingPlanGuid, int? page = default(int?), int? recordsPerPage = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<SpendingPlanIterationResponse>("/users/{user_guid}/spending_plans/{spending_plan_guid}/iterations/current", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
