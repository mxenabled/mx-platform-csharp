...
namespace MX.Platform.CSharp.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.13.0/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://int-api.mx.com") : this()
        {
        ...
        {
            string report = "C# SDK (MX.Platform.CSharp) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 20111101\n";
            report += "    SDK Package Version: 1.13.0\n";
