...
namespace MX.Platform.CSharp.Test.Api
{
    ...
    public class SpendingPlanApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ReadCurrentSpendingPlanIteration
        /// </summary>
        [Fact]
        public void ReadCurrentSpendingPlanIterationTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string userGuid = null;
            //string spendingPlanGuid = null;
            //int? page = null;
            //int? recordsPerPage = null;
            //var response = instance.ReadCurrentSpendingPlanIteration(userGuid, spendingPlanGuid, page, recordsPerPage);
