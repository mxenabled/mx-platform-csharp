...
namespace MX.Platform.CSharp.Test.Model
{
    ...
    public class ChallengesResponseBodyTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" ChallengesResponseBody
            //Assert.IsType<ChallengesResponseBody>(instance);
        }
