...
namespace MX.Platform.CSharp.Test.Model
{
    ...
    public class HoldingsResponseBodyTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" HoldingsResponseBody
            //Assert.IsType<HoldingsResponseBody>(instance);
        }
