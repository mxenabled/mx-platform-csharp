...
namespace MX.Platform.CSharp.Test.Model
{
    ...
    public class TransactionResponseBodyTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" TransactionResponseBody
            //Assert.IsType<TransactionResponseBody>(instance);
        }
