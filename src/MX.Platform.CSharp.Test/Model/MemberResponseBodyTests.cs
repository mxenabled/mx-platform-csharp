...
namespace MX.Platform.CSharp.Test.Model
{
    ...
    public class MemberResponseBodyTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" MemberResponseBody
            //Assert.IsType<MemberResponseBody>(instance);
        }
