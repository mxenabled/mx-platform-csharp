...
namespace MX.Platform.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionRuleCreateRequest")]
    public partial class TransactionRuleCreateRequest : IEquatable<TransactionRuleCreateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRuleCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionRuleCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionRuleCreateRequest" /> class.
        /// </summary>
        /// <param name="categoryGuid">categoryGuid (required).</param>
        /// <param name="description">description.</param>
        /// <param name="matchDescription">matchDescription (required).</param>
        ...
        {
            return this.Equals(input as TransactionRuleCreateRequest);
        }

        /// <summary>
        /// Returns true if TransactionRuleCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionRuleCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
